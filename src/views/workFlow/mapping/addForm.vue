...
<template>
    ...
    <el-col :span="24" style="background-color: white" >
        ...
        <el-form ref="addForm" :model="addForm"  :rules="rules" label-width="80px" style="margin-top: 20px;margin-bottom: 20px" class="demo-addForm">
            ...
            <el-col :span="8" :xs="20" >
                <el-form-item label="表单ID"  prop="procName" hidden>
                    <el-input v-model="addForm.id"   style="width: 95%" size="small"  readOnly hidden > </el-input>
                </el-form-item>
            </el-col>


            <el-col :span="8" :xs="20" >
                <el-form-item label="流程Key"  prop="procDefKey" hidden>
                    <el-input v-model="addForm.procDefKey"   style="width: 95%" size="small" readOnly hidden> </el-input>
                </el-form-item>
            </el-col>

            <el-col :span="8" :xs="20" >
                <el-form-item label="模型ID"  prop="modeId" hidden>
            ...
            <el-col :span="8" :offset="10">
                ...
                <el-button @click="submitForm('addForm')" icon="el-icon-circle-plus-outline" type="primary" style="margin-top: 20px;margin-bottom: 10px" round size="small">保存</el-button>
