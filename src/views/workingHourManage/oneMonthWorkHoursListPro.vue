    ...
    <div>
        <el-col :span="24" style="background-color: white;margin-bottom: 10px">
            ...
            <el-form ref="form" :model="searchForm" label-width="110px" style="margin-top: 20px;margin-bottom: 20px">
                <el-col :span="6" :xs="20" style="margin-left: -50px">
        ...
        <el-col :span="24" style="background-color: white;padding-top: 10px;padding-bottom: 10px;padding-left: 10px;font-size: 13px">
            ...
            <span style="margin-right: 10px;margin-left: 10px">{{"项目名称：  "+ projectName}}</span>
        ...
        methods: {
           /* 判断每条记录是否可勾选*/
            ...
            findAll(){
                this.$myHttp({
                    method: 'POST',
                    url: this.prefix+"viewWorkhour/getViewProjDetail"+window.suffix,
                    /*url:"http://192.168.99.38:9001/viewWorkhour/getViewProjDetail",*/
                    data: {
                         "entity": this.entity,
                         "ext": this.ext,
            ...
            getSummaries(param) {
                ...
                for(const items in sums){
                    if(items == '6'||items == '7'||items == '8'||items == '9'){
