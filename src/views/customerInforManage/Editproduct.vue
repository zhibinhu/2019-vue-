            ...
            <el-form :label-position="labelPosition" ref="ruleFormOne" :model="form" label-width="120px" :rules="rules"
                ...
                <el-col :span="8" :xs="20">
                    <el-form-item label="产品名称" prop="productName">    <!-- @blur="repeatJudgeInit"-->
                        <el-input v-model="form.productName" placeholder="请输入" style="width: 95%" size="small" @blur="remindRepeat"></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            remindRepeat(){
                ...
                if(this.form.productName==this.currentProductName){
                    _this.flag=true;
        ...
        created() {
            ...
            if (this.$route.query.id) {
                this.$myHttp({
                    ...
                    _this.currentProductName=res.data.rows[0].productName;
