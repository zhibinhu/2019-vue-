                    ...
                    <el-collapse-item style="padding:0 20px;background: #fff;" name="1">
                        ...
                        <el-row>
                            <el-col :span="9" class="inputPadding">
                                <el-form-item label="字典编码" prop="dtype">
                                    <el-input v-model="ruleForm.dtype" clearable size="small"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="9" class="inputPadding">
                                <el-form-item label="字典名称" prop="dname">
                                    <el-input v-model="ruleForm.dname" clearable size="small"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="18" class="inputPadding">
                                <el-form-item label="字典描述">
                                    <el-input v-model="ruleForm.memo" clearable size="small"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-collapse-item>
    ...
    export default {
        ...
        methods: {
            ...
            saveDict () {
                ...
                this.$myHttp({
                    method: 'POST',
                    url: this.prefix + '/microarch/sys/sysDictHead/checkDtypeExist',
                    data: {'entity': {'dtype': _this.ruleForm.dtype}}
                }).then(resDtype => {
                    if (resDtype.data.rows.length != '0') {
                        this.$message({
                            showClose: true,
                            message: '字典编码已存在！请重新输入字典编码！',
                            type: 'warning'
                        });
                    } else {
                        var _this = this;
                        ...
                        console.log('看看是啥', this.ruleForm);
                        this.$myHttp({
                            method: 'POST',
