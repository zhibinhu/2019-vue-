    ...
    <el-col :span="24">
        ...
        <el-form ref="ruleForm" :model="ruleForm"  :rules="rules" label-width="80px" style="margin-top: 0px;margin-bottom: 20px" class="demo-ruleForm">
                ...
                <el-collapse-item style="padding:0 20px;background: #fff;" name="1">
                    ...
                    <el-col :span="8" :xs="20" >
                        <el-form-item label="岗位编码"  prop="postCode">
                            <el-input v-model="ruleForm.postCode" disabled style="width: 95%" size="small"></el-input>
                        </el-form-item>
            ...
            <div style="text-align:center;position: fixed;width:calc(100% - 235px);;bottom:20px;">
                <el-button @click="submitForm('ruleForm')" icon="el-icon-circle-plus-outline" round type="primary" style="margin-top: 20px;margin-bottom: 10px" size="small">保存</el-button>
