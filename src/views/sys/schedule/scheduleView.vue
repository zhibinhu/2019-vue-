                        ...
                        <el-row>
                            <el-col :span="8">
                                <el-form-item label="bean名称" prop="beanName">
                                    <el-input v-model="ruleForm.beanName" size="small" clearable disabled></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="方法名称" prop="methodName">
                                    <el-input v-model="ruleForm.methodName" size="small" clearable disabled></el-input>

                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="参数" prop="params">
                                    <el-input v-model="ruleForm.params" size="small" clearable disabled></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="8">
                                <el-form-item label="cron表达式" prop="cronExpression">
                                    <el-input v-model="ruleForm.cronExpression" size="small" clearable disabled></el-input>

                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="备注" prop="remark">
                                    <el-input v-model="ruleForm.remark" size="small" clearable disabled></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </div>
