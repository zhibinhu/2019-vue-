...
<template>
    ...
    <el-col :span="24" style="background-color: white">
        ...
        <div style="margin-left: 15px;font-size: 16px">
            ...
            <oppo-detail :projectId="projectId" v-if="projectId!=null"></oppo-detail>
            ...
            <el-col :span="24" style="margin-bottom: 100px;padding-right: 15px" v-if="isFromEdit">
                ...
                <i class="el-icon-arrow-right"></i>展开
                    ...
                    <el-tab-pane  label="相关附件" name="accessories">
    ...
    export default {
        ...
        data() {
            return {
                ...
                attachment2:{
                    bizType:"oppo",
                    isViewButton:true,
                    refId:this.$route.query.projectId   /* 相关附件*/
                },
                showSixTable:true,
                showSixOpen:true,
                showSixClose:false
            ...
            processCallback(piid, optionType,taskType) {
                ...
                this.$myHttp({
                    ...
                    this.$myHttp({
                        ...
                        this.$refs.oppoCostForecast.tagClose('viewOppoCost');
                    });
                });
            },
            //20181129 09:23商机详细
        ...
        mounted:function () {
            ...
            if(this.$route.query.processInstanceId != null) {
                ...
                if(this.approval.taskType){
                    this.$refs.oppoCostForecast.submitVisable = true;
                }else{
                    this.$refs.oppoCostForecast.submitVisable = false;
                }
            }
