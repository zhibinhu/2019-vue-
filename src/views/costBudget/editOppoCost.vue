...
<template>
    ...
    <el-col :span="24" style="background-color: white">
        <div style="margin-left: 15px;font-size: 16px">
            ...
            <oppo-detail ref="oppoInfo" :projectId="projectId" v-if="projectId!=null"></oppo-detail>
            ...
            <el-col :span="24"  style="margin-bottom: 100px;padding-right: 15px">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="项目成本评估"  name="assessment">
                        ...
                        <div style="font-size: 14px;padding-left: 10px;margin-bottom: 10px;background: #F2F2F2;height: 40px;line-height: 40px;margin-top: 20px">
                           五、项目成本
                            <span style="float: right;margin-right: 15px;color: #409EFF;cursor: pointer" v-if="showFiveOpen" @click="showFive()">
                <i class="el-icon-arrow-up"></i>收起
            </span>
                            <span style="float: right;margin-right: 15px;color: #409EFF;cursor: pointer" v-if="showFiveClose" @click="showFive()">
                <i class="el-icon-arrow-right"></i>展开
            </span>
                        </div>

                        <el-row v-show="showFiveTable" style="border: 1px solid #DBE2EB;line-height: 40px">
                            ...
                            <el-col :span="18" style="padding-left: 10px">
                                <div class="grid-content bg-purple-light">{{util.returnFloat(allCost)}}</div>
                            ...
                            <el-col :span="18" style="padding-left: 10px">
                                <div class="grid-content bg-purple-light">{{util.returnFloat(costNoRate)}}</div>
                ...
                <i class="el-icon-arrow-right"></i>展开
                    ...
                    <el-tab-pane label="相关附件" name="enclosure">
                        <attach-table v-if="showSixTable && costForecastId!=null" :attachTable="attachment2"></attach-table>
                    </el-tab-pane>
                </el-tabs>
...
<script>
    ...
    import oppoDetail from '../commonView/oppoDetail.vue'
    ...
    export default {
        ...
        data() {
            return {
                ...
                attachment2:{
                    bizType:"oppo",
                    isViewButton:true,
                    refId:this.$route.query.projectId   /* 六 ，附件*/
                },
                test: [],
                perCost:{
        ...
        methods: {
            ...
            showFive(){
                if(this.showFiveTable){
                    this.showFiveOpen=false;
                    this.showFiveClose=true;
                    this.showFiveTable=false;

                }else{
                    this.showFiveOpen=true;
                    this.showFiveClose=false;
                    this.showFiveTable=true
                }
            },
            showSix(){
            ...
            getContractRateData:function () {
                ...
                if(this.approval.taskType){
                    this.$myHttp({
                        ...
                        this.attachment2.refId = data.projectId;
            ...
            processCallback(piid, optionType,taskType) {
                ...
                this.$myHttp({
                    ...
                    this.$myHttp({
                        ...
                        this.$refs.oppoCostForecast.tagClose('editOppoCost');
                    });
                });
            },
            //20181129 09:23商机详细
            findOneOppoInfo: function () {
                if(this.projectId) {
                    this.$myHttp({
                        ...
                        this.approval.processInstanceName = "商机成本预估【" + this.costForecastNum + "-商机名称:" + this.oppoProjectName + "】";
                    });
                }
            },
        },
        created() {
            ...
            this.approval.woCode = "oppo_costForecast"; //工单启动
            //20181129 09:23修改流程标题
